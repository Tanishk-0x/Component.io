...
const Login = () => {
  ...
  return (
    ...
    <div className="bg-neutral-950 relative h-screen w-screen flex justify-center items-center flex-col ">
        ...
        {/* --- Main Form --- */}
        <div className="absolute border-2 border-gray-800 bg-neutral-900 w-[95%] h-120 md:h-120 md:w-120 shadow-sm md:shadow-sm shadow-green-400 rounded-2xl flex justify-start items-center flex-col">
            ...
            Don't have an account? <span onClick={() => navigate('/signup')} className="text-green-400 font-medium hover:text-green-300 cursor-pointer"> Signup </span>
            </p>
